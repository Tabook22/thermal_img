...
export default function LibraryManager({open,onClose,onChange}:Props){
 ...
 if(!open)return null;
 const fileUrl=selected?`/api/library/documents/${selected.id}/file`:'';
